...
def parse():
    ...
    parser.add_argument('--data', type=str, default='/linhaitao/MEAN/summaries/sabdab_all.json', help='Path to the data file')
    parser.add_argument('--out_dir', type=str, default='/linhaitao/MEAN/summaries/RAbD', help='Directory to save results. Default the same as input data.')
    ...
    parser.add_argument('--cdr', type=str, choices=[f'H{i}' for i in range(1, 4)] + [f'L{i}' for i in range(1, 4)],
                        default=['H3'], nargs='+', help='Cluster according to which cdr, None for not clustering')
    parser.add_argument('--filter', type=str, default='111', help='Filter out complex with heavy / light / antigen.' + \
    ...
    parser.add_argument('--benchmark', type=str, default='/linhaitao/MEAN/summaries/rabd_all.json', help='Path to benchmark json file. If this is enabled, '+ \
