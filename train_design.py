...
from evaluation import average_test
from utils import set_seed, check_dir, print_log, write_result_to_file, EMAWeight, constant_weight
...
class Experiment:
    ...
    def _get_data_and_model(self, train_path, valid_path, cdr_type, initializer_path=None):
        ...
        if self.args.dybeta:
            ...
            beta = partial(constant_weight, weight=self.args.beta)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--beta', type=float, default=4, help='loss weight of local update geometry')
    parser.add_argument('--dybeta', type=bool, default=True, help=' if use dynamic loss weight of local update')
    ...
    parser.add_argument('--tag', type=str, default='H3_design', help='Use esm to encode sequence')
    ...
    parser.add_argument('--initializer_path', type=str, default='./results/cdrh3/H3_init/', help='Path to pretrained initializer') 
